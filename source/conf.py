...
# generate sitemap  https://pypi.org/project/sphinx-sitemap/
html_baseurl = 'https://en.vintageml.com/'
...
html_theme_options = {
    ...
    'navigation_depth': -1,
    'canonical_url': 'en.vintageml.com',
...
# https://www.sphinx-doc.org/en/master/usage/configuration.html
html_title = "Foundation of Machine Learning"
